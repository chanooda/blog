      ...
      <div id="resume" className="w-full mx-auto pt-10 px-4">
        <div className="w-full [&_li]:ml-8">
          <div className="flex flex-col space-y-4">
            {/* 기본정보 */}
            <div className="w-full shadow-[0_1px_3px_rgba(0,0,0,0.12),_0_1px_2px_rgba(0,0,0,0.24)] dark:bg-[#1e1e1e] p-4 rounded-sm">
            ...
            {!isMe && (
              <div className="rounded-xl">
                <p className="text-base">
                  ...
                  하였습니다. 그 후에는{" "}
                  <b>단독으로 사내 첫 내부 서비스 프론트엔드 개발에 참여</b>하여
                  웹앱 환경에서 동작하는 서비스를 개발하였습니다. 프론트엔드,
                  백엔드, 데스크탑 앱 등 크고 작은 프로젝트를 맡으며{" "}
                  ...
                  업무와 관련하여{" "}
                  <b>팀원들과 적극적으로 문제점과 개선점에 대해 소통</b>합니다.
                  <br />
                  <br />
                      ...
                      <li className="space-y-2">
                        ...
                        <div className=" space-y-1">
                          ...
                          <ul className="list-[square]">
                            ...
                            <li>
                              <b>Next.js 13의 변경되거나 새로운 기능을 적용</b>
                            </li>
