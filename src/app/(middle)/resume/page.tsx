            ...
            <>
              ...
              <div className="rounded-xl">
                <p className="text-base">
                  ...
                  프론트엔드, 백엔드, 데스크탑 앱 등 크고 작은 프로젝트를 맡으며{" "}
                  <b>다양한 개발자들과 협업할 수 있는 기반</b>을 닦았습니다.
                  <br />
                  <br />
                          ...
                          <ul className="mt-4 list-[circle] space-y-4">
                            ...
                            <li>
                              <div>
                                ...
                                <p>
                                  <b>
                                    - 모노레포 및 디자인 시스템을 이용한 관리자
                                    웹 서비스 단독 개발
                                  </b>
                                </p>
                                <p>
                                  <b>
                                    - react 관련 신규 라이브러리, 기술 실서비스
                                    도입
                                  </b>
                                </p>
                              </div>
                          ...
                          <div className=" space-y-1">
                            ...
                            <ul className="list-[square]">
                              <li>
                                ...
                                Chip, Badge <b>디자인 시스템 컴포넌트 생성</b>
                              </li>
                              <li>
