...
export default function Resume({ isMe = false }: ResumeProps) {
  ...
  return (
    <div className="w-full mx-auto pb-8">
      <div id="resume" className="w-full mx-auto pt-10 px-4">
        <div className="w-full [&_li]:ml-8">
              ...
              <>
                ...
                <div className="rounded-xl">
                  <p className="text-base">
                    React, Typescript를 주력으로 하는 개발 경력 1년차 웹 프론트
                    엔지니어 입니다.
                    <br />
                    <br />웹 프론트엔드 개발자로{" "}
                    <b>첫 입사 후 한달 뒤 주요 신규 프로젝트에 참여</b>{" "}
                    하였습니다.
                    <b>팀원과 소통하며 새로운 기술 스택들을 성공적으로 도입</b>
                    하였습니다. 그 후에는{" "}
                    <b>단독으로 사내 첫 내부 서비스 프론트엔드 개발에 참여</b>
                    하여 웹앱 환경에서 동작하는 서비스를 개발하였습니다.
                    프론트엔드, 백엔드, 데스크탑 앱 등 크고 작은 프로젝트를
                    맡으며 <b>다양한 개발자들과 협업할 수 있는 기반</b>을
                    닦았습니다.
                    <br />
                    <br />
                    로봇처럼 주어진대로 개발만 하는 것이 아닌, 언제나 개선점과
                    행동에 대한 <b>이유를 생각하며 개발</b>하려 하고 있습니다.
                    업무와 관련하여{" "}
                    <b>팀원들과 적극적으로 문제점과 개선점에 대해 소통</b>
                    합니다.
                    <br />
                    <br />
                    ...
                    튼튼한 기초를 새우며 개발과 협업에 대한 전반적인 이해를
                    쌓으려 합니다.
                  </p>
                </div>
                              ...
                              <ul className="mt-4 list-[circle] space-y-4">
                                <li>
                                  <div>
                                    ...
                                    <p>
                                      - 한국서부발전의 계좌이체거래약정서 등록
                                      정부과제 웹서비스 개발
                                    </p>
                                    <p>
                                      <b>
                                        - 사내 첫 내부 서비스 웹앱 프론트엔드
                                        단독 개발
                                      </b>
                                    </p>
                                  </div>
                  ...
                  <ul className="list-disc space-y-8">
                        ...
                        <ul className="list-[circle] space-y-4">
                          ...
                          <li>
                            ...
                            <ul className="list-[square]">
                              ...
                              <li>
                                <b>
                                  lerna, emotion을 이용한 모노레포 및 디자인
                                  시스템을 구성
                                </b>
                                하여 관리자 웹 서비스 구현
                              </li>
                              <li>
                                네이티브 앱과 연동하기 위한 모바일 환경 및
                                반응형 구현
                              </li>
                            </ul>
                          </li>
                    ...
                    <li>
                      <div>
                        ...
                        <p>
                          기존의 오프라인으로 진행 되었던 한국서부발전 사업
                          평가에 참여하는 회원의 정보를 관리하고 회원들의
                  ...
                  <ul className="list-disc space-y-8">
                          ...
                          <li className="space-y-2">
                            ...
                            <div className=" space-y-1">
                              ...
                              <ul className="list-[square]">
                                <li>
                                  <b>
                                    정기적인 회의를 통한 정책, 기능 설정 및 수정
                                  </b>
                                </li>
                                <li>
                                  다른 역할의 개발자, 디자이너들과의 회의를 통한
                                  개발 환경, 방식 구축
                                </li>
                                <li>
                                  <b>모노레포와 디자인 시스템에 대한 이해</b>
                                </li>
                                <li>
                                  <b>
                                    ec2, s3, codeDeploy, docker, github action을
                                    통한 배포 및 자동 배포 구현
                                  </b>
                                </li>
                              </ul>
                        ...
                        <ul className="list-[circle] mt-2 space-y-4">
                          ...
                          <li className="space-y-2">
                            ...
                            <div className=" space-y-1">
                              ...
                              <ul className="list-[square]">
                                <li>
                                  notion api를 이용하여 database, page의 정보를
                                  가져옴
                                </li>
                                <li>
                                  <b>
                                    notion api에서 제공하는 데이터를 바탕으로
                                    Notion 커스텀 컴포넌트 제작
                                  </b>
                                </li>
                                <li>
                                  <b>
                                    Next.js 13의 변경되거나 새로운 기능을 적용
                                  </b>
                                </li>
                    ...
                    <li>
                      <div>
                        ...
                        <p>
                          한국투자 오픈 api를 이용한 코스피 주식 정보 서비스
                        </p>
                        <div className="flex gap-2 mt-2 flex-wrap">
                          <Badge color="3178C6" label="TypeScript" />
                          <Badge
                          ...
                          <li className="space-y-2">
                            ...
                            <div className=" space-y-1">
                              ...
                              <ul className="list-[square]">
                                <li>
                                  <b>
                                    apex-chart 라이브러리를 사용해 주식 정보를
                                    차트화
                                  </b>
                                </li>
                                <li>
                                  <b>
                                    react query를 사용해 server state를 관리하고
                                    실시간 데이터를 관리
                                  </b>
                                </li>
                            ...
                            <div className="space-y-1">
                              ...
                              <ul className="list-[square]">
                                <li>
                                  express를 이용해 한국투자 오픈 api에 연결 및
                                  제공
                                </li>
                              </ul>
                            </div>
                            <div className=" space-y-1">
                              ...
                              <ul className="list-[square]">
                                ...
                                <li>
                                  <b>
                                    github-action, s3 bucket, codeDeploy를
                                    이용하여 자동배포 환경 구성
                                  </b>
                                </li>
                              </ul>
      ...
      {!isMe && (
        <div className="flex justify-end m-4">
          <button
            onClick={downloadPdf}
            className="font-semibold py-2 px-4 bg-gray-700 text-white dark:bg-gray-100 dark:text-gray-700 rounded-sm"
          >
            PDF 다운로드
          </button>
        </div>
